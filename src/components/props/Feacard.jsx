...
const Feacard = async ({ item, index }) => {
    ...
    return (
        <>
            ...
            <div key={index} className="relative w-[270px] h-[361px] flex flex-col overflow-hidden items-center text-center border border-shadow-[0px_0px_20px_10px_rgba(246,247,251,1)] group">
