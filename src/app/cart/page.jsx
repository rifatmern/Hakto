        ...
        <>
            <section className=''>
                <div className="pt-[98px] pb-[126px] bg-[rgba(246,245,255,1)]">
                    <Container>
                        <h1 className={`${Josef.className} font-bold text-[36px]`}>Shopping Curt</h1>
                        <p className={`${lato.className} font-normal text-[16px]`}> <span className='hover:text-[#FB2E86] cursor-pointer'>Home </span> <span className='hover:text-[#FB2E86] cursor-pointer'>. Pages </span> <span className='hover:text-[#FB2E86] cursor-pointer'>. Shopping Curt</span> </p>
                    </Container>
                </div>
                        ...
                        <div className="flex justify-between">
                            <div className="w-[70%]">
                                ...
                                <div className=" w-[100%] flex justify-between">
                                    <h2 className='w-[150px] h-[40px] rounded-[5px] flex items-center justify-center bg-[#FB2E86] text-[#fff] text-[17px] font-[500]' >Update Curt </h2>
                                    <h2 className='w-[150px] h-[40px] rounded-[5px] flex items-center justify-center bg-[#FB2E86] text-[#fff] text-[17px] font-[500]' >clear Cart</h2>
                                </div>
                            </div>
                            <div className="w-[30%]">
                                <div className={`${Josef.className} flex flex-col justify-center items-center`}>
                                    ...
                                    <div className="w-[371px] h-[284px] py-[34px] px-[31px] bg-[#F4F4FC] mt-[40px]">
                                        <div className="flex justify-between relative after:absolute after:contain-[''] after:bottom-[-10px] after:left-0 after:h-[1px] after:w-[100%] after:bg-[#fff]">
                                            ...
                                            <h3 className={`${lato.className} font-semibold text-[18px] text-[#1D3178]`}>£219.00</h3>
                                        </div>
                                        <div className="flex justify-between relative after:absolute after:contain-[''] after:bottom-[-10px] after:left-0 after:h-[1px] after:w-[100%] after:bg-[#fff] mt-[47px]">
                                            ...
                                            <h3 className={`${lato.className} font-semibold text-[18px] text-[#1D3178]`}>£325.00</h3>
                                        </div>
                                        ...
                                        <div className="flex justify-center mt-[35px] w-[312px] h-[40px] text-center pb-[35px]">
                                            <a href="" className={`${lato.className} font-normal w-[312px] h-[40px] leading-[40px] text-[#8A91AB] hover:text-[#FFF] hover:bg-[#19D16F] border border-[#19D16F] duration-200 ease-in-out`}>Proceed To Checkout</a>
                                        </div>
                                    </div>
                                </div>

                                <div className={`${Josef.className} flex flex-col justify-center items-center mt-[40px]`}>
                                    <h3 className='font-Sans font-bold text-[20px] text-[#0D0E43] text-center'>Calculate Shopping</h3>
                                    <div className="w-[371px] h-[294px] space-y-8 py-[34px] px-[31px] bg-[#F4F4FC] mt-[40px]">
                                        ...
                                        <div className="flex mt-[35px] w-[312px] h-[40px] text-center pb-[35px]">
                                            <a href="" className={`${lato.className} font-normal w-[189px] h-[40px] leading-[40px] text-[#8A91AB] hover:text-[#FFF] hover:bg-[#FB2E86] border border-[#FB2E86] duration-200 ease-in-out`}>Calculate Shiping</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
