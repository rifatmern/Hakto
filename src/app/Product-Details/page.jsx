                ...
                <div className="pt-[98px] pb-[126px] bg-[rgba(246,245,255,1)]">
                    <Container>
                        ...
                        <p className={`${lato.className} font-normal text-[16px]`}> 
                            ...
                            <span className='hover:text-[#FB2E86] cursor-pointer'>. Shop Grid Default </span> 
                        </p>
                    </Container>
                </div>
            </section>
                    ...
                    <div className="mainBox flex py-[100px] gap-[40px] w-[100%]">
                        <div className="ProdectImgBox flex h-[390px] gap-[10px] w-[50%]">
                            <div className="miniimgbox w-[25%]">
                                <Image className=' mb-[8px] w-[100%] h-[125px] border-[1px] border-[#9e9e9e] rounded-[6px]' 
                            ...
                            <div className="w-[75%]">
                                <Image 
                                    ...
                                    className='h-[391px] w-[100%] border-[1px] border-[#9e9e9e] rounded-[6px]' 
                                    alt="Main Product" 
                                    width={391} 
                                    height={391} 
                                />
                        ...
                        <div className="ProdectDetailBox w-[50%] py-[30px]">
                            ...
                            <h3 className='text-[16px] text-[#151875] font-[600] mb-[10px]'>
                                $3200 <span className=' ml-[10px] text-[#FB2E86]'>20% <span className=' uppercase '>discount</span></span>
                            </h3>
                            <p className='text-[#8A8FB9] w-[549px] font-[600] text-[16px] mb-[10px] block'></p>
                            <h2 className=' pb-[10px] text-[20px] text-[#FB2E86] font-[700]'>
                                Stock : <span className='font-[500] text-[#000]'>5</span>
                            </h2>
                            <Link href="/cart">
                                <p className={`${Josef.className} flex w-[200px] font-semibold text-[16px] py-4 justify-center mt-[10px] items-center gap-x-2 border border-[#FB2E86]`}>
                                    Add To cart <CiHeart className='text-[25px]' />
                                </p>
                            </Link>
                ...
                <Container>
                    <div className="py-[100px]">
                        ...
                        <div className="mt-[70px]">
                            ...
                            <p className={`${Josef.className} font-Sans font-bold text-[16px] text-[#A9ACC6] mt-[20px]`}>
                                Aliquam dis vulputate integer sagittis. Faucibus dolor ornare vel sed habitasse amet. Montes, mauris varius ac est bibendum.
                            </p>
                        </div>
                        <div className="mt-[70px]">
                            ...
                            <div className="flex mt-[15px] items-center space-x-4">
                                ...
                                <p className={`${Josef.className} font-Sans font-bold text-[16px] text-[#A9ACC6]`}>
                                    Aliquam dis vulputate integer sagittis. Faucibus ds diam arcu, nulla lobortis justo netus dis.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div className="px-3">
                        ...
                        <div className="lg:flex justify-between mt-[40px]">
                            <div className="lg:w-[24%] w-full">
                                <Image className='w-full' src="/images/related-product1.jpg" alt="Related Product 1" width={200} height={200} />
                                ...
                                <h5 className='font-Sans font-bold text-[16px] text-[#0D0E43] mt-[10px] mb-[20px]'>$43.00</h5>
                            </div>
                            {/* Add other related products similarly */}
                        </div>
                    </div>
                </Container>
            </section>
