...
const Shop = () => {
    return (
        <>
            <div className="relative w-[270px] h-[363px] flex flex-col overflow-hidden items-center text-center shadow-[0px_0px_20px_10px_rgba(246,247,251,1)] group">
                <div className=" flex items-center h-[280px] justify-center w-full transition duration-500 ease-in-out group-hover:bg-[#EBF4F3]">
                    <Image src={feapro} alt="feapro" className="object-cover h-[201px] w-[201px] pt-[33px] pb-[7px]" />
                </div>
