                    ...
                    <div className="mainBox flex py-[100px] gap-[40px] w-[100%]">
                        <div className=" ProdectImgBox flex h-[390px] gap-[10px] w-[50%]">
                            <div className="miniimgbox w-[25%]">
                                <img className=' mb-[8px] w-[100%] h-[125px] border-[1px] border-[#9e9e9e] rounded-[6px]' src={"#"} alt="" />
                                <img className=' mb-[8px] w-[100%] h-[125px] border-[1px] border-[#9e9e9e] rounded-[6px]' src={"#"} alt="" />
                                <img className=' mb-[8px] w-[100%] h-[125px] border-[1px] border-[#9e9e9e] rounded-[6px]' src={"#"} alt="" />
                            </div>
                            <div className="bigimgbox w-[75%]">
                                <img src="#" className='h-[391px] w-[100%] rounded-[6px]' alt="" />
                            </div>
                        </div>
                        <div className="ProdectDetailBox w-[50%] py-[30px]">
                            ...
                            <icon></icon>
                            <h3 className='text-[16px] text-[#151875] font-[600] mb-[10px]'>$200 <span className=' ml-[10px] text-[#FB2E86]'>5% <span className=' uppercase '>discount</span></span> </h3>
                            <p className='text-[#8A8FB9] w-[549px] font-[600] text-[16px] mb-[10px] block'></p>
                            <h2 className=' pb-[10px] text-[20px] text-[#FB2E86] font-[700]'>Stock : <span className='font-[500] text-[#000]'>12</span></h2>
                            <p className={`${Josef.className} flex w-[200px] font-semibold text-[16px] py-4 justify-center items-center gap-x-2 border border-[#FB2E86]`}>Add To cart<CiHeart className='text-[25px]' /></p>
                            <h2>Categories:</h2>
                            <h2>Tags:</h2>
